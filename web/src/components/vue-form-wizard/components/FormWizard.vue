<template>
  <div>
    ...
    >
      ...
      <div class="col-auto">
        <!-- :class="stepsClasses" -->
        <ul class="step-list disabled position-relative" role="tablist">
          <slot
            name="step"
    ...
    <div class="settings-footer row justify-content-between">
        ...
        <div class="col-auto">
          <slot name="prev" v-bind="slotProps">
            <button
              ...
              :disabled="loading"
            >
              <i class="vik vik-left"></i> {{ backButtonText }}
            </button>
          </slot>
          ...
          <div class="btn-line">
            ...
            >
              <slot name="finish" v-bind="slotProps">
                <wizard-button class="btn-secondary">
                  {{ finishButtonText }}
                </wizard-button>
              </slot>
            </span>
            ...
            >
              <slot name="next" v-bind="slotProps">
                <wizard-button class="btn-secondary" :disabled="loading">
                  {{ nextButtonText }}
                </wizard-button>
              </slot>
            </span>
